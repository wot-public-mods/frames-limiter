...
labeles_l10n = {
	'uk': {
		'checkboxText': 'Максимальна частота кадрів',
		'tooltipText': "{HEADER}Максимальна частота кадрів{/HEADER}{BODY}Встановлює максимальну частоту кадрів для 3D-рендерингу.\nОбмеження частоти кадрів найчастіше використовується для:\n\n• Зменшення навантаження та, як наслідок, нагрівання та шуму відеокарти.\n• Збільшення стабільності та плавності ігрового процесу.\n• Збільшення автономності під час гри на ноутбуці.{/BODY}",
	},
	'ru': {
